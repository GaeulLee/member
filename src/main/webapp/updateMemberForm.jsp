...
<html>
	...
	<div class="container w-25" id="verticalMiddle">
		<form action="<%=request.getContextPath()%>/updateMemberAction.jsp" method="post" class="align_middle">
			<table class="table table-borderless table-light rounded-3 shadow p-4 bg-white">
				<tr>
					<td colspan="2">
						<h3><strong>회원정보 수정</strong></h3>
					</td>
				</tr>
				<!-- 메세지 출력 -->
				<%
				...
				<tr>
					<td>회원 이름</td>
					<td><input type="text" name="memberName" value="<%=member.memberName%>" class="form-control w-75 mx-auto"></td>
				</tr>
				<tr>
					<td>회원 ID</td>
				...
				<tr>
					<td>회원 PW</td>
					<td><input type="password" name="memberPw" class="form-control w-75 mx-auto" readonly="readonly"></td>
				</tr>
				<tr>
					<td colspan="2">
